...
const MOCK_ADMIN = {
  ...
  bio: 'System administrator for the Teacher Attendance System.',
  profile_image: '',
  role: 'admin' as const,
};
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            {/* Tab Content */}
            {activeTab === 'profile' && (
              <ProfileForm user={MOCK_ADMIN} onSuccess={handleProfileUpdate} />
            )}

            {activeTab === 'notifications' && (
              <NotificationPreferencesComponent userId={MOCK_ADMIN.id} />
            )}
